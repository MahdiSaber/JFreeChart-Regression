...
public class PriceEstimator extends ApplicationFrame
{
	...
	private JFreeChart createChart(XYDataset inputData) throws IOException
	{
		...
		JFreeChart chart = ChartFactory.createScatterPlot("My Diagram", "The X Values", "The Y values", inputData,
	...
	private void drawRegressionLine()
	{
		...
		XYDataset dataset = DatasetUtilities.sampleFunction2D(linefunction2d, 0D, 300, 100, "Fitted Regression Line");
